...
public class PromptBuilder {
    ...
    public String systemInstructions() {
        return """
            ...
            3. Output Formatting: Maintain the analytical, objective, and concise tone of a systems architect. Deliver factual data based strictly on the provided context, eliminating conversational fluff.
            """;
    }
